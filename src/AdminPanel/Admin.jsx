          ...
          <div className="px-4">
            <div className="flex items-center justify-between">
              <div className="flex shrink-0">
                ...
                >
                  <img className="h-12 rounded-xl w-auto" src={logo} alt="" />
                  <p className="text-black font-bold">Go TO HOME</p>
                </Link>
              </div>
        ...
        <div className="">
          ...
          >
            <div
              ...
              className="mt-3 cursor-pointer absolute right-0 -top-2"
            >
              <span className="px-2 py-1 bg-black text-white font-bold rounded-full mt-3">
                X
              </span>
            </div>
